	...
	\begin{titlepage}
		...
		\begin{addmargin}[1em]{0em}
			...
			\begin{center}
				...
				\end{minipage}%
				\begin{minipage}[b]{0.3\textwidth}
					\textbf{Hobbies/Interests:}\\ Martial Arts, Tennis\\ Playing around with A.I./M.L.\\ Software Development\\ Trading, Financial Markets\\
				\end{minipage}
			\end{center}
		\end{addmargin}
		\vspace{-10pt}
...
- Used MySQL to interact with a database of financial information\newline
- Contributed Java and PHP code to the software infrastructure of the company\newline
